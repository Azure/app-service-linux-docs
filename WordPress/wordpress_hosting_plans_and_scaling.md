...
**1. Scale up:** Get more CPU, memory, disk space, and extra features like dedicated virtual machines (VMs), custom domains and certificates, staging slots, autoscaling, and more. You scale up by changing the pricing tier of the App Service plan that your app belongs to. 
<kbd><img src="./media/scaling_wordpress_1.png" width="1000" /></kbd>

**2. Scale out:** Increase the number of VM instances that run your app. You can scale out to as many as 30 instances, depending on your pricing tier.
<kbd><img src="./media/scaling_wordpress_2.png" width="1000" /></kbd>
...
<kbd><img src="./media/scaling_wordpress_3.png" width="1000" /></kbd>
<kbd><img src="./media/scaling_wordpress_4.png" width="1000" /></kbd>
