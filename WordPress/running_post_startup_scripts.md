...
<br>
Navigate to WebSSH/Bash shell in scm portal of your WordPress app. You can access the SCM site either from Azure Protal or using the following URL **https://\<sitename\>.scm.azurewebsites.net**
